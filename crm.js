...
function dialerInit(queue) {
    ...
    dialerPanel.innerHTML = `
        ...
        <div style="padding:10px 14px 8px;text-align:center;">
            ...
            <div id="dialer-countdown-text" style="font-size:22px;font-weight:bold;color:#e74c3c;font-variant-numeric:tabular-nums;">25</div>
        ...
        if(dialerMinimized) {
            ...
            if(!document.getElementById('dialer-mini-bar')) {
                ...
                miniBar.innerHTML = `
                    ...
                    <span id="mini-countdown" style="font-size:13px;font-weight:bold;color:#e74c3c;font-variant-numeric:tabular-nums;white-space:nowrap;min-width:36px;">00:25</span>
